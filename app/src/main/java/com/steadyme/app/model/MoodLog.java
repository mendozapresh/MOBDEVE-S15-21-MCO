...
public class MoodLog {
    private String id, emotion, notes, source;
    private int score;
    private Timestamp createdAt;
    public MoodLog() { }
    public MoodLog(String emotion, String notes, String source, int score) { this.emotion=emotion; this.notes=notes; this.source=source; this.score=score; this.createdAt=Timestamp.now(); }
    public String getId(){return id;} public void setId(String id){this.id=id;}
    public String getEmotion(){return emotion;} public void setEmotion(String emotion){this.emotion=emotion;}
